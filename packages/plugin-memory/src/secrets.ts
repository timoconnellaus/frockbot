...
//
// This is Package policy and it is only here. `core/contracts` deliberately
...
// `@frockbot/core/secret-shapes`, because the Audit Package needs the same list to
...
import { matchSecretShapeV1 } from "@frockbot/core/secret-shapes";
