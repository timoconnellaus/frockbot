...
/// worth sending once the upstream is awake. Flux decides where a turn ends
/// and needs the silence after the words to decide it, so an awake session
/// gets every frame. [quietForMs] exists for the one policy that does stop
/// the audio: twenty continuous seconds of quiet while listening.
///
