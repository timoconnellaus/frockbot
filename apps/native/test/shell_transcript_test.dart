...
Map<String, dynamic> run({
  ...
  // A failed Turn's reason and its partial answer reach a client on the run's
  // `outcome`, which is where the projection puts the sentence it wrote for
  // the person. The stored `failure` is a provider diagnostic and never
  // crosses the wire, so a fixture that carried one would be testing a shape
  // the product cannot receive.
  if (failure != null)
    'outcome': {
      'type': 'failed',
      'message': failure,
