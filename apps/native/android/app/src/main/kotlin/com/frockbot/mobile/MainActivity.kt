...
class MainActivity : FlutterActivity() {
    ...
    override fun configureFlutterEngine(flutterEngine: FlutterEngine) {
        ...
        audioRoute = VoiceAudioRoute(this, flutterEngine.dartExecutor.binaryMessenger)
    ...
    override fun cleanUpFlutterEngine(engine: FlutterEngine) { speaker?.close(); speaker = null; audioRoute?.close(); audioRoute = null; PushNotifications.bridge = null; super.cleanUpFlutterEngine(engine) }
