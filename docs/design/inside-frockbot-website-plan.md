...
| 8     | Memory, Skills, and routines, `#continuity`  | Distinguish history from memory, explain Bot/User/Group Chat memory, instruction directories, scheduled and event-driven work, and how multiple Bots can cooperate.                                                              | Small linked examples; avoid a second system diagram.                              |
