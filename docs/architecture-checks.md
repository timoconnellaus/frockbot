...
| — a missing, disabled, or revoked Connection is unavailable and records a visible, repairable failure; no request widens authority | `apps/cloudflare/test/package-catalog-bot.workerd.ts`               | `installs hash-pinned code, remounts after a Connection appears, and package_undo removes it`                                                        | workerd |
