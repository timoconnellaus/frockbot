...
| every generation preserves the exact first-party bootstrap core                                                | `packages/kernel-do/src/composition-store.test.ts`                                                                                                     | `refuses proposals that remove or replace the first-party bootstrap core`                                                                                                                                                                                                                 | Bun          |
