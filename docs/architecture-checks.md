...
| the Fly provider labels update progress for the Computer surface                                                                                           | `packages/plugin-fly-sprite/src/computer.test.ts`                                                                      | `describes an in-place runtime update in the provider message`                                                                   | Bun    |
...
| the shared client machine enters and leaves `updating`, and an updating strip click only expands its progress                                              | `packages/plugin-computer/src/client/state-machine.test.ts`, `packages/plugin-computer/src/client/application.test.ts` | `moves into updating with its label and out when connection completes`, `an updating strip click only expands the progress view` | Bun    |
