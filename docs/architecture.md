...
**What is still missing.** An automation Turn is not yet separated from the visible transcript — it appears in `GET /api/bots/:id/turns` today — and there is no completion inbox and no pending wake. Those are slice E.
