...
| 26  | "Update Computer" (fresh instance, keep files+logins, lose packages) and "Reset" (snapshot restore)                                                                                                                                                             | settings `update-computer` two-click confirm; `reset-computer`                                                                                                     | §2A, §9            | `computer`; in-place runtime-document updates are automatic on wake; VM replacement and Reset remain User actions deferred behind row 32                                                                                                                                                                                                                                                                                                                                                                                          | partial                                             |
| 26b | **Durability** — snapshot-out-only sync of the per-Bot state DBs on a debounce + tick, control files excluded                                                                                                                                                   | `box-store-sync`: 120 s tick, 5 s DB debounce, 15 min Chrome, `AGENT_STORE_DB_BASENAMES`, `box-store-sync.lock`                                                    | §3.3               | `computer`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        | partial                                             |
