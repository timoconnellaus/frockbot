...
| 43  | Multi-account connectors with per-account labels; MCP lifecycle (status, restart, rename, instructions)                                                                                                                                                         | Gmail/Calendar/Drive ×5; `GetMcpServerStatus`, `SetMcpInstructions`                                                                                                | §16, §17           | `core/connection` + `plugin-mcp` (servers, tools, status, restart, instructions, rename, `mcp-remote-oauth` grant driver)                                                                                                                                                                  | partial                                             |
