...
| 36  | External channel connectors (Telegram etc.) connected and disconnected per Bot                                                                                                                                                                                  | info-pane Channels; `update_state channel disconnect{platform}`                                                                                                    | §2.14, §2A         | `app/email`: a per-Bot inbound address; the User's sign-in address and the senders they confirm become user-lane `email` Turns once the receiving server's DMARC verdict passes.                                                                                                           | partial — inbound email 2026-09-24                  |
