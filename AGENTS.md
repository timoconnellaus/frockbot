...
- A user-facing change people will see after an update adds a What’s New entry in the same PR, so the still can be reviewed there. Procedure: [`.claude/skills/whats-new/SKILL.md`](.claude/skills/whats-new/SKILL.md).
