...
import type { FrockBotWebData } from "@frockbot/app/shell/shared";
...
} from "@frockbot/app/shell/focus";
import { showClientNotificationV1 } from "@frockbot/app/shell/client/notify";
import {
...
export const clientContribution = defineClientContribution<ClientPlugin>({
  specifier: "@frockbot/app/flock/client",
